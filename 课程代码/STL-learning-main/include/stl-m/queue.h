#ifndef DEALII_QUEUE_H_
#define DEALII_QUEUE_H_
...
namespace mystl
{
  ...
  public:
    ...
    void
    swap(queue &rhs) noexcept(noexcept(mystl::swap(c_, rhs.c_)))
    {
  ...
  public:
    friend bool
    operator==(const queue &lhs, const queue &rhs)
    {
  ...
  public:
    ...
    priority_queue &
    operator=(const priority_queue &rhs)
    {
      c_    = rhs.c_;
      comp_ = rhs.comp_;
      mystl::make_heap(c_.begin(), c_.end(), comp_);
  ...
  public:
    ...
    void
    swap(priority_queue &rhs) noexcept(noexcept(
  ...
  public:
    friend bool
    operator==(const priority_queue &lhs, const priority_queue &rhs)
    {
      return lhs.c_ == rhs.c_;
    }
    friend bool
