#ifndef DEALII_UNORDERED_SET_H_
#define DEALII_UNORDERED_SET_H_
...
namespace mystl
{
  ...
  public:
    ...
    void
    swap(unordered_set &other) noexcept
    {
      ht_.swap(other.ht_);
    }
  ...
  public:
    ...
    void
    swap(unordered_multiset &other) noexcept
    {
      ht_.swap(other.ht_);
    }
  ...
  public:
    friend bool
    operator==(const unordered_multiset &lhs, const unordered_multiset &rhs)
    {
