#ifndef DEALII_UNORDERED_MAP_H_
#define DEALII_UNORDERED_MAP_H_
...
namespace mystl
{
  ...
  public:
    ...
    unordered_map &
    operator=(const unordered_map &rhs)
    {
      ht_ = rhs.ht_;
      return *this;
    }
    unordered_map &
    operator=(unordered_map &&rhs)
    {
      ht_ = mystl::move(rhs.ht_);
      return *this;
    }
    ...
    void
    swap(unordered_map &other) noexcept
    {
      ht_.swap(other.ht_);
    }
    ...
    const_local_iterator
    cbegin(size_type n) const noexcept
    {
      return ht_.cbegin(n);
    }
    ...
    const_local_iterator
    cend(size_type n) const noexcept
    {
      return ht_.cend(n);
    }
  ...
  public:
    ...
    unordered_multimap &
    operator=(const unordered_multimap &rhs)
    {
      ht_ = rhs.ht_;
      return *this;
    }
    unordered_multimap &
    operator=(unordered_multimap &&rhs)
    {
      ht_ = mystl::move(rhs.ht_);
      return *this;
    }
    ...
    void
    swap(unordered_multimap &other) noexcept
    {
      ht_.swap(other.ht_);
    }
  ...
  public:
    friend bool
    operator==(const unordered_multimap &lhs, const unordered_multimap &rhs)
    {
  ...
  template <class Key, class T, class Hash, class KeyEqual>
  bool
  operator==(const unordered_multimap<Key, T, Hash, KeyEqual> &lhs,
